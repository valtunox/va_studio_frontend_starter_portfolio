/**
 * VA Studio Frontend — Portfolio Standalone
 *
 * This is a standalone version of the Portfolio template.
 * It renders the Portfolio template directly as the main interface.
 *
 * Routes:
...
import TemplateApp from '../templates/portfolio/App.jsx'
...
/* ------------------------------------------------------------------ */
/*  Home Page (Portfolio Template with Connectivity Banner)       */
/* ------------------------------------------------------------------ */
